...
`silver-svc-billing-mesh` is centered on backend services work in Kotlin. The technical target is: Design a Kotlin verification harness for billing systems, covering format conversion, round-trip fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 176. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 4.
