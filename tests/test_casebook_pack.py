"""Regression checks for the silver-svc-billing-mesh casebook."""
...
from casebook.harness import assert_expected, silver_svc_billing_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_svc_billing_mesh_summary(), assert_expected())
